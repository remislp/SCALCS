...
class MecListDlg(QDialog):
    ...
    def __init__(self, meclist, max_mecnum, parent=None):
        ...
        self.mList.itemSelectionChanged.connect(self.mecSelected)

        self.rList = QListWidget()
        self.rList.itemSelectionChanged.connect(self.rateSelected)
        ...
        layout2.addWidget(myqtcommon.ok_cancel_button(self))
...
class RateTableDlg(QDialog):
    ...
    def __init__(self, mec=None, log=None, parent=None):
        ...
        self.table.cellChanged.connect(self.tableItemChanged)
...
class ConstrainMultiplyDlg(QDialog):
    ...
    def __init__(self, parent=None, mec=None):
        ...
        self.fEdit.editingFinished.connect(self.on_par_changed)
